package com.halovoid.lncrawler.ui.feature.settings.components
...
@Composable
fun BackupFrequencyBottomSheet(
    currentFrequency: String,
    onFrequencySelected: (String) -> Unit,
    onDismiss: () -> Unit
) {
    val options = listOf("Off", "Daily", "Weekly", "Monthly")

    AppBottomSheet(
        onDismiss = onDismiss,
        title = "Backup Frequency",
        subtitle = "Choose how often automated backups should run."
    ) {
        AppBottomSheetGroup {
